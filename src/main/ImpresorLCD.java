...
public class ImpresorLCD /*extends JFrame*/ {
    
    //JTextField matriz = new JTextField(); 
    ...
    private void imprimirNumero(int size, String numeroImp, int espacio) 
    {
       ...
       /* setSize(500, 500);
        ...
        content.add(matriz);
        matriz.setBounds(new Rectangle(0,0,100,100));
        */
        ...
        for (int i = 0; i < this.totalFilas; i++) {
            for (int j = 0; j < this.totalColum; j++) {
                ...
                //matriz.setText(this.matrizImpr[i][j]); 
                //content.add(matriz);
          }
            System.out.println();
             //matriz.setText(" ");
     ...
     * de los digitos y los digitos a imprimir, tambien de validar que la entrada 
     * sea la esperada
     *
    ...
    public void procesar(String comando, int espacioDig) {
        ...
        int tam;
        String Mexception;
        //Lanza una excepcion si se presenta alguna inconcistencia en la entrada
        try{
            //Valida que La cadena contenga el caracter " , "
            if (!comando.contains(",")) 
            {
            ...
            //Captura la excepcion y lanza una lista de las posibles causas del error
            JOptionPane.showMessageDialog(null, "La Cadena ingresada es invalida,el problema puede deberse a:\n\n "
                                                + "1.La Cadena " + comando + " no contiene el caracter , \n"
                                                + "2.Cadena " + comando +" contiene mas caracter.\n"
                                                + "3.Cadena "+comando+" no contiene los parametros requeridos.\n"
                                                + "4.El parametro size debe estar entre 1 y 10\n"
                                                + "5.El parametro size no es numerico", 
                                                "Entrada Invalida", JOptionPane.ERROR_MESSAGE);
            String respuesta = JOptionPane.showInputDialog(null, "Digite nuevamente el numero", " Entrada", JOptionPane.WARNING_MESSAGE);
            Entrada rest = new Entrada(respuesta);
        }
     }
